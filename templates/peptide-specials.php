<?php
/* Template Name: Peptide Specials */
get_header();
?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-12 sidebar_grid-right">
                <h2 class="title">Peptide Specials</h2>
                <p class="description">Purchase US Made Peptides Online Direct From Our Online Catalogue.</p>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <?php
                        ...
                        echo '<p class="filter_p m-0">' . ($product_count ? $product_count : '0') . ' items</p>';
                    ?>
                ...
                <section id="product_tags">
                    <div class="d-flex flex-wrap product_tags-products">
                        <?php
                            ...
                            $product_count = $featured_query->found_posts;
