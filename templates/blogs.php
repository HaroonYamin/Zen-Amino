    ...
    <div class="container">
        <div class="archive_row">
            <section class="archive_left">
                <button class="archive_left-button" type="button" data-bs-toggle="collapse" data-bs-target="#filter" aria-expanded="false" aria-controls="filter">Filter Categories</button>
                <div class="archive_left-filter collapse show" id="filter">
                    <div class="archive_search">
                        <h4 class="desktop">Search the blog</h4>
            ...
            <section class="archive_right">
                <h2 class="title">Peptide Blog</h2>
                ...
                <?php
                    ...
                    ?>
                            <article class="archive_item">
                                <a href="<?php the_permalink(); ?>" class="archive_title">
                                    <h2><?php the_title(); ?></h2>
                                </a>
                                ...
                                <div class="archive_article-footer">
                                    <span class="categories">Posted in: <?php the_category(', '); ?></span>
                                    <a href="<?php the_permalink(); ?>" class="archive_read-more">Read More</a>
                                </div>
                            </article>
                    <?php
                        endwhile;
