...
<h2 class="account_dashboard-headings"><?php esc_html_e( 'My Orders', 'woocommerce' ); ?></h2>
...
<?php else : ?>
	<p class="account_order-not"><?php echo esc_html__( 'No order has been made yet.', 'woocommerce' ); ?></p>
<?php endif; ?>
